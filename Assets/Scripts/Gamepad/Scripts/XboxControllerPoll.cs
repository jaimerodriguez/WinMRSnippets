...
{       
    void Start()
    {
        TraceHelper.Log("XboxControllerPoll Started");
    ...
    void Update()
    {
        ...
        if (GamepadWatcher.Current.IsPresent.Value)
        {             
    ...
    {
        TraceHelper.Log("XboxController Gamepad added handler"); 
    }

    void JustDemoPurposes_GamepadRemoved (object sender, System.EventArgs unused)
    {
        TraceHelper.Log("XboxController Gamepad removed handler");
    }
