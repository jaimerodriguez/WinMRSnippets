...
// Extend the toolkit's motion controller 
...
#else
    public class MotionControllerVisualizer : MonoBehaviour, IControllerVisualizer
#endif
    {
        ...
        private void Start()
        {
            ...
            Debug.Assert(false, "This class does not work in Unity5_6, look at sample code in MotionController Listener");
            Destroy(this); 
// #error This class does not work in Unity 5.6. We want to keep it close to Original Toolkit and adding 5.6 would be too disruptive. Look at MotionControllerListener for 5.6 sample code. Comment out after reading 
#endif
...
#else
                    currentController.Update(sourceState, nodeType );                
                    if (ShowDebugAxis)
                    {
                        UpdateDebugAxis( sourceState ); 
                    }
